...
class Staff extends Admin_Controller
{
    ...
    public function school_create(){
        ...
        // $this->form_validation->set_rules('branch', $this->lang->line('branch'), 'trim|required|xss_clean');
        ...
        $this->load->view('layout/header', $data);
        $this->load->view('admin/staff/schoolcreate', $data);
        $this->load->view('layout/footer', $data);
    ...
    public function save_school() {
        ...
        $insertId = $this->staff_model->insert_school_data($data_insert);
        ...
        if($insertId){
            ...
            $roleinsertId = $this->staff_model->insert_role_data($role_insert);
    ...
    public function getCities() {
        ...
        $state = $this->input->get('state_id');
        $data = $this->staff_model->getCitiesByState($state);
